  ...
  return (
    <div className="space-y-8 p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center">
        ...
        {editingId && (
          <button onClick={cancelEdit} className="text-red-500 font-bold uppercase text-[10px] tracking-widest border border-red-500/20 px-5 py-2.5 rounded-xl hover:bg-red-500 hover:text-white transition-all">
            {t("cancel")}
          </button>
        )}
      </div>
      ...
      <form onSubmit={(e) => { e.preventDefault(); productMutation.mutate(editingId ? { ...formData, id: editingId } : formData); }} 
        ...
        <button type="submit" disabled={productMutation.isPending} 
                className="mt-8 px-12 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl font-black uppercase tracking-widest transition-all flex items-center gap-3 shadow-lg shadow-blue-500/20 disabled:opacity-50">
